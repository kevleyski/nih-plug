...
impl Default for Kasm {
    fn default() -> Self {
        Self {
            params: Arc::new(KasmSynthParams::default()),
...
impl Default for KasmSynthParams {
    fn default() -> Self {
        Self {
            gain: FloatParam::new(
                "Gain",
...
impl Plugin for Kasm {
    const NAME: &'static str = "Kasm";
    const VENDOR: &'static str = "Pyrmont Brewery";
    const URL: &'static str = "https://pyrmontbrewery.com";
...
nih_export_clap!(Kasm);
nih_export_vst3!(Kasm);
